...
optimizer_base = optim.Adam(model.parameters(), lr=args.lr)
#optimizer = optim.lr_scheduler.ReduceLROnPlateau(optimizer_base, 'min')
...
for epoch in range(1, args.epochs + 1):
    train(epoch)
    test()
    torch.save(model, "model-emnist2.torch")
    print('saved')
